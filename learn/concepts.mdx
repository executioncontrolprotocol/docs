...
- [Quickstart](/getting-started/quickstart) — Run a sample Context with the published CLI
- [Why ECP?](/learn/why-ecp) — Security, control, and extensibility at a glance
...
- [Alternatives and comparisons](/alternatives) — How ECP compares to other stacks
